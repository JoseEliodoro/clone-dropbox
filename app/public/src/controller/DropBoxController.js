class DropBoxController{
    constructor(){
        ...
        // Chamada das função quando a página carregar
    ...
    connectFirebase(){
        const firebaseConfig = {
            apiKey: "AIzaSyA0CbhkDzh6c-8gffTROY2v8Xp28UQCV8c",
            authDomain: "dropbox-clone-878c6.firebaseapp.com",
            databaseURL: "https://dropbox-clone-878c6-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-878c6",
            storageBucket: "dropbox-clone-878c6.appspot.com",
            messagingSenderId: "212218920643",
            appId: "1:212218920643:web:4ac2f487c25761db75ac76",
            measurementId: "G-YVWG2XG03V"
        };
    ...
    removeFolderTask(ref, name){
        return new Promise((resolve, reject)=>{
            ...
            let folderRef = this.getFilebaseRef(ref +'/'+ name);
    ...
    removeTask(){
        ...
        this.getSelection().forEach(li=>{
            ...
            if (file.filepath){
                ...
                formData.append('path', file.filepath.replace('C:\\Users\\Client\\Documents\\JavaScript\\clone-dropbox\\app\\', ''));
    ...
    initEvents(){
        ...
        this.btnNewFolder.addEventListener('click', e=>{
            ...
            let name = prompt('Nome da nova pasta:', 'New Folder');
            ...
            this.uploadTask(event.target.files).then(responses =>{
                ...
                */
                ...
                for (let x=0;x<responses.length;x++){
                    resp.push(JSON.parse(responses[x]));
                }
    ...
    renderNav(){
        ...
        for (let i=0;i <= this.currentFolder.length-1;i++){
    ...
    initEventLi(li){
        ...
        li.addEventListener('dblclick', e=>{
            ...
            switch (file.mimetype){
                ...
                break;
                default:
                    //window.open('/file?path='+file.filepath.replace('C:\\Users\\Client\\Documents\\JavaScript\\clone-dropbox\\app\\', ''));
